...
describe("TerminalLexer", () => {
  ...
  const reconstruct = (tokens: Token[]): string => {
  ...
  describe("Complex Sequences", () => {
    ...
    test("handles your original complex example", () => {
      const input =
        "\x1B[1m\x1B[7m%\x1B[m\x1B[1m\x1B[m                                                                                                                                                                                                                \r \r\r\x1B[m\x1B[m\x1B[m\x1B[JZartharus% \x1B[K\x1B[?1h=\x1B[?2004h";
      const tokens = tokenize(input);
      verifyReconstruction(input);
    });
  });
